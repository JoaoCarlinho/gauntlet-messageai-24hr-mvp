...
# HTTPS Listener (primary) - disabled until SSL certificate is available
# Uncomment after obtaining ACM certificate (Story 7.3)
...
# HTTP Listener (forward to target group - HTTPS redirect disabled until SSL cert available)
